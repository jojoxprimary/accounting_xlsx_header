...
class JournalReportCustomHandler(models.AbstractModel):
    ...
    def export_to_xlsx(self, options, response=None):
        ...
        for journal_vals in document_data['journals_vals']:
            ...
            # Create a format without borders for header and footer
            no_border_format = workbook.add_format({'bold': False, 'border': 1, 'border_color': 'white'})
            no_border_bold_format = workbook.add_format({'bold': True, 'border': 1,'border_color': 'white'})
            ...
            sheet.write(0, 0, "Company Name:", no_border_bold_format)
            sheet.write(0, 1, company.name, no_border_format)
            sheet.write(1, 0, "Book Type:", no_border_bold_format)
            sheet.write(1, 1, book_type.title(), no_border_format)
            sheet.write(2, 0, "VAT No.:", no_border_bold_format)
            sheet.write(2, 1, company.vat or '', no_border_format)
            sheet.write(3, 0, "Address:", no_border_bold_format)
            sheet.write(3, 1, company.partner_id.contact_address or '', no_border_format)
            sheet.write(4, 0, "Period Covered:", no_border_bold_format)
            sheet.write(4, 1, options.get('date', {}).get('string', ''), no_border_format)
            ...
            footer_start_row = cursor_y + 1
            # Write footer information
            sheet.write(footer_start_row, 0, "Software:", no_border_bold_format)
            sheet.write(footer_start_row, 1, software_info, no_border_format)
            sheet.write(footer_start_row + 1, 0, "Generated By:", no_border_bold_format)
            sheet.write(footer_start_row + 1, 1, f"{current_user.name}", no_border_format)
            sheet.write(footer_start_row + 2, 0, "Generation Date:", no_border_bold_format)
            sheet.write(footer_start_row + 2, 1, generation_date, no_border_format)
